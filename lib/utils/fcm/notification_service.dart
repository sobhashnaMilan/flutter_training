...
class NotificationService extends Object {
  ...
  NotificationService._internal() {
    flutterPrint(msg: "💣 😀 =====> Firebase Messaging instance created");
  ...
  Future<void> firebaseCloudMessagingListeners() async {
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      flutterPrint(msg: "💣 😀 =====> onMessageOpenedApp: $message");
  ...
  Future<String?> getFCMToken() async {
    try {
      ...
      if (token != null && token.isNotEmpty) {
        flutterPrint(msg: "💣 😀 =====> FCM Token :: $token");
        _fcmToken = token;
      }
      return _fcmToken;
    } catch (e) {
      flutterPrint(msg: "💣 😀 =====> Error :: ${e.toString()}");
      return null;
    }
  }
  ...
  void displayNotificationView(RemoteMessage? message) {
    ...
    flutterPrint(msg: "💣 😀 =====> Display notification view");
    flutterPrint(msg: "💣 😀 =====> channel id ${channel.id}");
    ...
    flutterLocalNotificationsPlugin.initialize(
      ...
      onSelectNotification: (payload) {
        flutterPrint(msg: "💣 😀 =====> arguments -> $payload");
